...
export interface IBadge extends Document {
  ...
  badgeIconUrl?: string; // URL for the badge icon/image
}
...
const BadgeSchema = new Schema<IBadge>(
  {
    ...
    badgeIconUrl: {
      type: String, // Field for storing the URL of the badge icon
      default: "",  // Default empty, can be updated with an icon URL
    },
  },
  {
